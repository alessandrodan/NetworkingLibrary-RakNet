...
public:
	...
	SLNet::DynDnsResultCode GetCompletedResultCode(void)
	{
		return result;
	}
...
protected:
	void Stop(void);
	void SetCompleted(SLNet::DynDnsResultCode _result, const char *_resultDescription)
	{
		Stop(); result = _result; resultDescription = _resultDescription;
	}
