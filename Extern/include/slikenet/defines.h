...
/// Set this to 1 if you want the implicit conversion e.g. of SLNet::RakString to const char*
#ifndef USE_IMPLICIT_CONVERSIONS
#define USE_IMPLICIT_CONVERSIONS 0
#endif
