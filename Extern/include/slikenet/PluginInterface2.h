...
public:
	...
	{
		(void)packet; return RR_CONTINUE_PROCESSING;
	}
	...
	{
		(void)systemAddress; (void)rakNetGUID; (void)lostConnectionReason;
	}
	...
	{
		(void)packet; (void)failedConnectionAttemptReason;
	}
	...
	{
		(void)data; (void)bitsUsed; (void)remoteSystemAddress;
	}
	...
	{
		(void)errorMessage; (void)bitsUsed; (void)remoteSystemAddress; (void)isError;
	}
	...
	{
		(void)internalPacket; (void)frameNumber; (void)remoteSystemAddress; (void)time; (void)isSend;
	}
	...
	{
		(void)messageNumber; (void)remoteSystemAddress; (void)time;
	}
